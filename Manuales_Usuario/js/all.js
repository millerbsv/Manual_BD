...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Museo de America","Insertar","Elementos","Iconografía","Museo","Cultura","Colección","Objetos","Iconografía principal","Elementos iconográficos"],
	DREX_NODE_LINKS: ["museo_de_america.htm","insertar.htm","elementos.htm","iconografia.htm","museo.htm","cultura.htm","coleccion.htm","objetos.htm","iconografia_principal.htm","elementos_iconograficos.htm"],
	DREX_NODE_CHILD_START: [1,2,4,8,10,10,10,10,10,10],
	DREX_NODE_CHILD_END: [2,4,8,10,10,10,10,10,10,10],
	DREX_MENU_TYPE: 3,
